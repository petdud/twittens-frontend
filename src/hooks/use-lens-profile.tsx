...
//   return profile !== null && profile !== undefined && (profile as Profile).followStatus !== undefined;
// }

// export const useLensProfile = (storedProfile: ILensProfile | null) => {
//     let { data: fetchedProfile, loading } = useProfile({ handle: storedProfile?.handle || "" });

//     const isProfileFetched = storedProfile && fetchedProfile && storedProfile?.id === fetchedProfile?.id && !loading;
