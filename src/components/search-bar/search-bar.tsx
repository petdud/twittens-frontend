      ...
      <Combobox as="div" value={selectedCollection} onChange={onChange}>
        <div className="relative mt-1">
          <div
            ...
            aria-hidden="true"
          >
            <MagnifyingGlassIcon className="mr-3 h-4 w-4 text-gray-800" aria-hidden="true" />
          </div>
          <Combobox.Input
            className="pl-8 w-full rounded-md border border-gray-300 shadow-md bg-white py-2 pr-10 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm"
