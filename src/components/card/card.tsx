...
export const Card = ({imageUrl, name, description, isFeatured}: ICard) => (
...
export const CardSkeleton = () => (
  <div role="status" className="p-4 w-full rounded-lg shadow-lg animate-pulse bg-white dark:bg-neutral-800">
