...
const features = [
  ...
  'Get notified when new 𝕏 account appears on xFrens',
...
const faqs = [
  ...
  },
  {
    ...
    answer: (
      <>
        We are open to sponsor a listing for a community that is not listed yet. If you
        ...
        . We&apos;ll also consider listing a community for free if it is a charity,
        community without revenue (no royalties) or a project that contributes greatly to
        the adoption of web3. We&apos;ll also list notable communities with strong public
        interest for free for you to enjoy.
      </>
    )
  },
  {
    ...
    answer: (
      <>
        We&apos;ll use the fund to continue developing this product and adding new
        features that helps NFT communities to connect and discover new opportunities. A
        part of it will also go for covering the cost of updating the data of all
        communities. We don&apos;t know how else we could monetize this project and we
        think it&apos;ll be fun for a community to get together and contribute to get
        listed.
      </>
    )
  },

  {
    ...
    answer: (
      <>
        Leaderboard is a section where you can see which collections and users have the
        most followers on Twitter. Only communities listed on xFrens are included in the
        leaderboard as it would be otherwise impossible to keep it up to date. <br />
        <a
          href="https://xfrens.xyz/leaderboard"
          target="_blank"
          rel="noreferrer"
          className={linkClassName}
        >
          ...
          <div className="border-t border-gray-200 pt-16 xl:grid xl:grid-cols-3 xl:gap-x-8">
            <div>
              ...
              <p className="mt-4 text-lg text-gray-500 dark:text-gray-300">
                Get together 10 community members to chip-in 0.01 ETH each and get listed
                on xFrens. Start building and connecting your community with the help of
                xFrens!
              </p>
            </div>
        ...
        <div className="mx-auto max-w-7xl py-16 px-6 sm:py-24 lg:px-8">
          ...
          <div className="mt-6 border-t border-blue-400 border-opacity-25 pt-10">
            <dl className="space-y-10 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-x-8 md:gap-y-12 md:space-y-0">
              {faqs.map(item => (
                <div key={item.id}>
                  <dt className="text-lg font-medium leading-6 text-neutral-800 dark:text-white">
                    {item.question}
                  </dt>
                  <dd className="mt-2 text-base text-neutral-400 dark:text-blue-200">
                    {item.answer}
                  </dd>
                </div>
              ))}
