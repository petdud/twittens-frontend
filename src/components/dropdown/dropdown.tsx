...
export const Dropdown = ({name, children, appearance = "button"}: IDropdownProps) => {
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items style={{zIndex: "10"}} className="absolute overflow-visible right-0 z-10 mt-2 w-44 origin-top-right border border-neutral-200 dark:border-neutral-600 rounded-md bg-white dark:bg-neutral-800 shadow-sm ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            {children}
          </div>
        </Menu.Items>
