                ...
                <div className="px-1 divide-y divide-gray-200 dark:divide-gray-700 mr-4">
                  <div className="flex items-center gap-3 justify-between divide-y-2 divide-gray-200 dark:divide-neutral-700">
                    <div className="flex items-center gap-2 dark:text-gray-200 mb-2">
                      ...
                      <span className="flex items-end text-xs text-gray-500 dark:text-neutral-400">
                        ({shortenedAddress(address)}) <CopyButton value={address} />
                      </span>
                    </div>
                  </div>
                  <div className="py-3">
                    <div className="relative flex items-start">
                      {twitter?.avatar && (
                        <div className="flex-shrink-0 flex">
                          ...
                          <img
                            className="h-12 w-12 md:h-16 md:w-16 rounded-full mr-4 mt-1"
                            src={twitter?.avatar}
                      ...
                      <div className="min-w-0 flex-1 flex gap-2 flex-col">
                        <div>
                          <div className="flex items-center">
                            <h3 className="text-base font-medium text-gray-900 dark:text-white overflow-hidden">
                              {twitter?.name}
                            </h3>
                            {twitter?.verified && (
                        ...
                        {communities && communities.length > 0 && (
                          <div className="mb-2 mt-1 overflow-hidden">
                            <span className="text-gray-500 dark:text-gray-400 text-sm font-normal pb-1">
                              Communities:
                            </span>
                        ...
                        <div className="flex gap-4 text-sm items-center">
                          ...
                          <div className="flex dark:text-white flex-col-reverse md:flex-row md:gap-1">
                            <span className="font-semibold">
                              {twitter?.tweetCount.toLocaleString()}
                            </span>{' '}
                            <span className="text-gray-500 dark:text-gray-400 text-sm font-normal">
                              Tweets
                            </span>
...
const CloseButton = ({ onClose }: { onClose: () => void }) => {
  return (
    <div className="absolute top-0 right-0 text-lg p-2">
      <button
        onClick={onClose}
        className="p-2 text-gray-800 dark:text-gray-300 hover:dark:text-white hover:bg-neutral-100 hover:dark:bg-neutral-700 rounded-md"
      >
        <AiOutlineClose />
      </button>
    </div>
