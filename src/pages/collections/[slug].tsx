...
export default function Collection({ slug, meta }: ICollectionProps) {
  ...
  return (
    <div>
      <HeadPage
        title={`${collectionName ? collectionName : 'NFT'} holders on 𝕏 | xFrens.xyz`}
        description={`Discover and connect with ${
          collectionName + ' ' || ''
        }NFT holders on 𝕏 thanks to xFrens.xyz and ENS.`}
